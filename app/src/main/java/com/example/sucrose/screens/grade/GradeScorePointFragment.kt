...
import com.example.sucrose.recycle.ControlDotView
...
class GradeScorePointFragment : Fragment() {
    ...
    lateinit var view_controlpoint: ArrayList<ControlDotView>
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view_controlpoint = arrayListOf<ControlDotView>()
    ...
    private fun parseControlPoint(StudentRatingPlan: StudentRatingPlan): Double {
        ...
        var view_controlpoint: ArrayList<ControlDotView>
        view_controlpoint = arrayListOf<ControlDotView>()
        ...
        for (section in Sections) {
            ...
            //view_controlpoint.add(ControlDotView(heading,true,0.0,0.0))//заголовок
...
//                view_controlpoint.add(ControlDotView(
//                    title,
//                    false,
//                    ball,
//                    maxball))
